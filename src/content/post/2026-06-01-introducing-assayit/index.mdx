...
description: "Manual fact-checking and generic AI summaries both fail when the cost of being wrong is high. It led me to building Assay, a tool that makes document review jobs. It extracts a document's claims and researches each one separately for evidence, not vibes."
