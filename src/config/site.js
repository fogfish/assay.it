...
const SITE_URL = import.meta.env.PUBLIC_SITE_URL || "https://assay.it";
...
export const siteConfig = {
	...
	meta: {
		...
		description:
			"Paste a whitepaper or blog post. Assay extracts claim and checks it. Verdicts and citations as decision one-pager in minutes.",
		keywords:
			"claim verification, whitepaper fact checking, vendor benchmark verification, technical due diligence, AI research agent, RFC decision document, document review",
